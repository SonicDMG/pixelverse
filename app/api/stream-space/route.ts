 ...
 * Stream space/astronomy responses from the built-in agent.
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('[Stream Space API] Streaming from agent, question:', questionValidation.sanitized);

    // Pipe the async generator into a ReadableStream
    const agentStream = streamAgent(questionValidation.sanitized!, 'space', session_id);
